...
INSERT INTO `task` VALUES (1,'WipeDeletedObjects','Wipe deleted collections and assets and their associated reviews','delete_disabled()'),(2,'DeleteStaleReviews','Delete reviews that no longer match any rule in the system','delete_stale(\"system\")'),(3,'DeleteStaleAssetReviews','Delete reviews that no longer match an asset\'s assigned rules','delete_stale(\"asset\")'),(4,'AnalyzeReviewTables','Analyze database tables for performance','analyze_tables(JSON_ARRAY(\"reviews\", \"review_history\"))');
...
INSERT INTO `job` VALUES (1,'Wipe Deleted Objects','Wipe deleted collections and assets and their associated reviews',NULL,NULL,'2025-10-02 15:43:49.868',NULL);
...
INSERT INTO `job_task_map` VALUES (1,1,1,'2025-10-02 15:43:49.881','2025-10-02 15:43:49.881'),(2,1,4,'2025-10-02 15:43:49.881','2025-10-02 15:43:49.881');
