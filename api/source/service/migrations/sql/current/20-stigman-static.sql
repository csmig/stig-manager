...
INSERT INTO `task` VALUES (1,'WipeDeletedObjects','Wipe deleted collections and assets and their associated reviews','delete_disabled()',NULL),(2,'DeleteStaleReviews','Delete reviews that no longer match any rule in the system','delete_stale(\"system\")',NULL),(3,'DeleteStaleReviews/Asset','Delete reviews that no longer match an asset\'s assigned rules','delete_stale(\"asset\")',NULL),(4,'OptimizeTables','Optimize database tables for performance','optimize_tables()',NULL);
