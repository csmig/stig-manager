...
SM.TipContent.CloneOptions.ClickThru = `<b>CLICK THRU</b><br><br>
The click-thru text The click-thru text The click-thru text The click-thru text 
The click-thru text The click-thru text The click-thru text The click-thru text 
The click-thru text The click-thru text The click-thru text The click-thru text 
The click-thru text The click-thru text The click-thru text The click-thru text 
The click-thru text The click-thru text The click-thru text `

SM.TipContent.CloneOptions.Grants = `<b>Clone the source Collection's users and their grants.</b><br><br>Whether this option is selected or not, the creator of the cloned
Collection will be given an Owner grant in the clone.`

SM.TipContent.CloneOptions.Labels = `<b>Clone the source Collection's available labels.</b><br><br>You must select this option AND the Assets option for labels to be mapped to
Assets in the clone.`

SM.TipContent.CloneOptions.Assets = `<b>Clone the source Collection's Assets and their core properties.</b><br><br>This option must be selected to enable 
the STIGs and Pin Revisions options below.`

SM.TipContent.CloneOptions.Stigs = `<b>Assignments and Reviews:</b> Assets will be cloned with their current STIG assignments and ALL stored Reviews. This will include Reviews 
that are no longer associated with a current STIG assignment or are associated with a non-default Revision of a STIG.<br><br>
...
SM.TipContent.CloneOptions.Revisions = `<b>Match the source's pinned Revisions:</b> STIGs in the source Collection that are pinned to a specific Revision will be pinned to
that Revision in the clone. STIGs that track the latest Revision in the source will be unpinned in the clone.<br><br>
<b>Pin the source's default revisions:</b> All STIGs in the clone will be pinned to a specific Revision. STIGs that are pinned to a specific Revision in the source Collection will be pinned to
that Revision in the clone. STIGs that track the latest Revision in the source will be pinned to the current latest Revision in the clone.`
